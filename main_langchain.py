...
def get_conversation_chain(vectorstore):
    prompt_template = """Sử dụng các thông tin trong văn bản sau đây để trả lời câu hỏi ở cuối. Nếu không biết câu trả lời, bạn chỉ cần nói rằng bạn không biết, đừng cố bịa ra câu trả lời. 
    ...
    llm = HuggingFacePipeline(pipeline = text_pipeline, model_kwargs={"temperature": 0.3, "max_length":512,'device': 'cpu'})
...
def main():
    ...
    with st.sidebar:
        ...
        uploaded_file = st.file_uploader(
            "Upload your documents here, accept multiple files", accept_multiple_files=False)
